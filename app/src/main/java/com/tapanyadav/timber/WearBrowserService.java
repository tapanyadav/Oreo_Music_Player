...
import com.tapanyadav.timber.dataloaders.AlbumLoader;
import com.tapanyadav.timber.dataloaders.AlbumSongLoader;
import com.tapanyadav.timber.dataloaders.ArtistAlbumLoader;
import com.tapanyadav.timber.dataloaders.ArtistLoader;
import com.tapanyadav.timber.dataloaders.ArtistSongLoader;
import com.tapanyadav.timber.dataloaders.PlaylistLoader;
import com.tapanyadav.timber.dataloaders.PlaylistSongLoader;
import com.tapanyadav.timber.dataloaders.SongLoader;
import com.tapanyadav.timber.models.Album;
import com.tapanyadav.timber.models.Artist;
import com.tapanyadav.timber.models.Playlist;
import com.tapanyadav.timber.models.Song;
import com.tapanyadav.timber.utils.TimberUtils;
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" +
                                "naman14.timber/drawable/ic_empty_music1"))
                    ...
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0)))) {
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_SONG_ALBUMS) + Long.toString(artist.id), artist.name, Uri.parse("android.resource://" +
                                        "naman14.timber/drawable/ic_empty_music1"), TimberUtils.makeCombinedString(mContext, albumNmber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        case TYPE_ALBUM:
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            fillMediaItems(mediaItems, Integer.toString(TYPE_ARTIST_ALL_SONGS) + Long.parseLong(parentId.substring(1)), "All songs", Uri.parse("android.resource://" +
                                    "naman14.timber/drawable/ic_empty_music1"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                                "naman14.timber/drawable/ic_empty_music1"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
