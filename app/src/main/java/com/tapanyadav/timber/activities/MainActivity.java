...
import com.tapanyadav.timber.fragments.AlbumDetailFragment;
import com.tapanyadav.timber.fragments.ArtistDetailFragment;
import com.tapanyadav.timber.fragments.MainFragment;
import com.tapanyadav.timber.fragments.PlaylistFragment;
import com.tapanyadav.timber.fragments.QueueFragment;
import com.tapanyadav.timber.permissions.Nammu;
import com.tapanyadav.timber.permissions.PermissionCallback;
import com.tapanyadav.timber.slidinguppanel.SlidingUpPanelLayout;
    ...
    private void updatePosition(final MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.nav_help:
                ...
                Uri data = Uri.parse("mailto:yadav.tapanpr@gmail.com");
                intent.setData(data);
    ...
    public void setDetailsToHeader() {
        ...
        ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
                new DisplayImageOptions.Builder().cacheInMemory(true)
                        .showImageOnFail(R.drawable.ic_empty_music1)
